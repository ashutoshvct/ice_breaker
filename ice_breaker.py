...
def ice_break_with(name: str) -> Tuple[Summary, str]:
    ...
    summary_template = """
    Act as an expert summary writer. Given the information about a person from linkedin {information},
     and their latest twitter posts {twitter_posts} I want you to create:
    1. A short summary
    2. Two or more interesting facts about the person
...
if __name__ == "__main__":
    ...
    ice_break_with(name="Ashutosh Maheshwari Nutanix awscloudengineer X")
